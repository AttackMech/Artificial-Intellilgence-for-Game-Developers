 ...
 * object.  The current position is tracked, and a focus point is used to allow the position of the entity to be tracked
 * from any point, not just the top corner of the image.  Several of these variables are protected so that the class can be
